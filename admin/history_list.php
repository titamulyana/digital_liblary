...
<?php
    ...
    $all_loan = loans_controller::get_loan_history();
?>
<!--Main layout-->
<main style="margin-top: 58px;">
  <div class="container pt-4">
      <div class="d-flex justify-content-start mt-2 mb-2">
        <h3 class="fs-5">List Riwayat Peminjaman Buku</h1>
      </div>
    ...
    <tbody>
      ...
      ?>
        ...
        <td>
            ...
            <?php
            if($row['status'] == '1') {
                echo '<button disabled class="btn btn-success btn-sm">Sudah Dikembalikan</button>';
            } else {
                echo '<button disabled class="btn btn-danger btn-sm">Belum Dikembalikan</button>';
            }
            ?>
            </p>
        </td>
